...
const LoggedIn = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 dark:text-white flex flex-col">
      <header className="w-full h-[5.6rem] px-6 py-4 flex justify-between items-center border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md">
        ...
        <div className="flex items-center gap-3 relative">
          <a
            href="/allpost"
            className="px-4 py-2 h-11 rounded-xl border border-gray-300 bg-gray-100 text-gray-700 hover:bg-gray-200 transition dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
          >
            Dashboard
          </a>
          ...
          <img
            ...
            src="/user.png"
            alt="user"
            className="w-15 rounded-xl hover:bg-blue-100 transition"
          />
      ...
      <section
        id="community"
        className="w-full max-w-7xl mx-auto px-6 py-20 text-center bg-gray-100 dark:bg-gray-700/30 rounded-3xl"
      >
      ...
      <section
        id="contact"
        className=" w-full max-w-7xl mx-auto px-6 py-10 flex flex-col justify-center gap-6 items-center md:flex-row md:pl-[22rem]"
      >
        <div>
